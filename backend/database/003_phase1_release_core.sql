...
IF OBJECT_ID('dbo.ScanFindings') IS NOT NULL AND COL_LENGTH('dbo.ScanFindings', 'ReleaseId') IS NULL
  ALTER TABLE dbo.ScanFindings ADD ReleaseId BIGINT NULL;
IF OBJECT_ID('dbo.ScanFindings') IS NOT NULL AND COL_LENGTH('dbo.ScanFindings', 'ScanType') IS NULL
  ALTER TABLE dbo.ScanFindings ADD ScanType NVARCHAR(40) NULL;
IF OBJECT_ID('dbo.ScanFindings') IS NOT NULL AND COL_LENGTH('dbo.ScanFindings', 'RuleId') IS NULL
  ALTER TABLE dbo.ScanFindings ADD RuleId NVARCHAR(120) NULL;
IF OBJECT_ID('dbo.ScanFindings') IS NOT NULL AND COL_LENGTH('dbo.ScanFindings', 'Fingerprint') IS NULL
  ALTER TABLE dbo.ScanFindings ADD Fingerprint NVARCHAR(200) NULL;
